class SiteManagerE6ai extends SiteManager
{
    constructor(sitesManager, pageLimit)
    {
		super(sitesManager, SITE_E6AI, 'https://e6ai.net', pageLimit);
    }
    ...
    buildRequestUrl(searchText, pageNumber)
	{
		...
		let possibleLogin = this.sitesManager.model.e6aiApiKey && this.sitesManager.model.e6aiLogin ? '&login=' + this.sitesManager.model.e6aiLogin + '&api_key=' + this.sitesManager.model.e6aiApiKey : '';
	...
	{
		// Ref: Discord > e6ai.net > Donovan DMC
		// Take the file.md5 (as an example: AABBCCCCCCCCCCCCCCCCCCCCCCCCCCCC)
		// and convert it to
		// https://static1.e6ai.net/data/AA/BB/AABBCCCCCCCCCCCCCCCCCCCCCCCCCCCC.{file.ext}
		
		const BASE_PATH = 'https://static1.e6ai.net/data/';
