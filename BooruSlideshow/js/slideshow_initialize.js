...
document.addEventListener('DOMContentLoaded', function () {
    slideshowController = new SlideshowController({
        ...
        'e6aiLoginContainer': document.getElementById('e6ai-login-container'),
        'e6aiApiKeyContainer': document.getElementById('e6ai-api-key-container'),
        'e6aiLogin': document.getElementById('e6ai-login'),
        'e6aiApiKey': document.getElementById('e6ai-api-key'),
